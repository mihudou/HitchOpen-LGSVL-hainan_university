...
BT::PortsList IfInStraight::providedPorts()
{
  return {
...
BT::NodeStatus IfInStraight::tick()
{
    ...
    race::ttl::TrackLocation::STRAIGHT)
  {
    RCLCPP_INFO_THROTTLE(
      ...
      config().blackboard->get<const std::shared_ptr<ros_parameters::Params>>(
        "rde_params")->non_critical_log_time_period_ms, "In Straight Region");
