...
IfRivalCarBackGapLesserThan::IfRivalCarBackGapLesserThan(
  const std::string & name,
  const BT::NodeConfiguration & config)
: BT::ConditionNode(name, config)
{}

BT::PortsList IfRivalCarBackGapLesserThan::providedPorts()
{
  return {
...
BT::NodeStatus IfRivalCarBackGapLesserThan::tick()
{
