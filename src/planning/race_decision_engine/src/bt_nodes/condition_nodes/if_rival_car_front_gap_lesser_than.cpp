...
IfRivalCarFrontGapLesserThan::IfRivalCarFrontGapLesserThan(
  const std::string & name,
  const BT::NodeConfiguration & config)
: BT::ConditionNode(name, config)
{}

BT::PortsList IfRivalCarFrontGapLesserThan::providedPorts()
{
  return {
...
BT::NodeStatus IfRivalCarFrontGapLesserThan::tick()
{
